...
// 0013_add_use_mailservers.down.sql (0)
// 0013_add_use_mailservers.up.sql (111B)
// doc.go (74B)
...
func _0006_appearanceUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "0006_appearance.up.sql", size: 67, mode: os.FileMode(0644), modTime: time.Unix(1599559876, 0)}
...
func _0007_enable_waku_defaultUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "0007_enable_waku_default.up.sql", size: 38, mode: os.FileMode(0644), modTime: time.Unix(1599559876, 0)}
...
func _0008_add_push_notificationsUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "0008_add_push_notifications.up.sql", size: 349, mode: os.FileMode(0644), modTime: time.Unix(1599559876, 0)}
...
func _0009_enable_sending_push_notificationsDownSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "0009_enable_sending_push_notifications.down.sql", size: 49, mode: os.FileMode(0644), modTime: time.Unix(1599559876, 0)}
...
func _0009_enable_sending_push_notificationsUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "0009_enable_sending_push_notifications.up.sql", size: 49, mode: os.FileMode(0644), modTime: time.Unix(1599559876, 0)}
...
func _0010_add_block_mentionsDownSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "0010_add_block_mentions.down.sql", size: 83, mode: os.FileMode(0644), modTime: time.Unix(1599682300, 0)}
...
func _0010_add_block_mentionsUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "0010_add_block_mentions.up.sql", size: 89, mode: os.FileMode(0644), modTime: time.Unix(1599682300, 0)}
...
func _0011_allow_webview_permission_requestsDownSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "0011_allow_webview_permission_requests.down.sql", size: 0, mode: os.FileMode(0644), modTime: time.Unix(1599736519, 0)}
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0xe3, 0xb0, 0xc4, 0x42, 0x98, 0xfc, 0x1c, 0x14, 0x9a, 0xfb, 0xf4, 0xc8, 0x99, 0x6f, 0xb9, 0x24, 0x27, 0xae, 0x41, 0xe4, 0x64, 0x9b, 0x93, 0x4c, 0xa4, 0x95, 0x99, 0x1b, 0x78, 0x52, 0xb8, 0x55}}
	return a, nil
}
...
func _0011_allow_webview_permission_requestsUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "0011_allow_webview_permission_requests.up.sql", size: 88, mode: os.FileMode(0644), modTime: time.Unix(1599736519, 0)}
...
func _0012_pending_transactionsDownSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "0012_pending_transactions.down.sql", size: 33, mode: os.FileMode(0644), modTime: time.Unix(1600152154, 0)}
...
func _0012_pending_transactionsUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "0012_pending_transactions.up.sql", size: 321, mode: os.FileMode(0644), modTime: time.Unix(1600152154, 0)}
...
var __0013_add_use_mailserversDownSql = []byte("\x1f\x8b\x08\x00\x00\x00\x00\x00\x00\xff\x01\x00\x00\xff\xff\x00\x00\x00\x00\x00\x00\x00\x00")

func _0013_add_use_mailserversDownSqlBytes() ([]byte, error) {
	return bindataRead(
		__0013_add_use_mailserversDownSql,
		"0013_add_use_mailservers.down.sql",
	)
}

func _0013_add_use_mailserversDownSql() (*asset, error) {
	bytes, err := _0013_add_use_mailserversDownSqlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "0013_add_use_mailservers.down.sql", size: 0, mode: os.FileMode(0644), modTime: time.Unix(1600152155, 0)}
	a := &asset{bytes: bytes, info: info, digest: [32]uint8{0xe3, 0xb0, 0xc4, 0x42, 0x98, 0xfc, 0x1c, 0x14, 0x9a, 0xfb, 0xf4, 0xc8, 0x99, 0x6f, 0xb9, 0x24, 0x27, 0xae, 0x41, 0xe4, 0x64, 0x9b, 0x93, 0x4c, 0xa4, 0x95, 0x99, 0x1b, 0x78, 0x52, 0xb8, 0x55}}
	return a, nil
}

var __0013_add_use_mailserversUpSql = []byte("")

func _0013_add_use_mailserversUpSqlBytes() ([]byte, error) {
	return bindataRead(
		__0013_add_use_mailserversUpSql,
		"0013_add_use_mailservers.up.sql",
	)
}

func _0013_add_use_mailserversUpSql() (*asset, error) {
	bytes, err := _0013_add_use_mailserversUpSqlBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "0013_add_use_mailservers.up.sql", size: 111, mode: os.FileMode(0644), modTime: time.Unix(1600153381, 0)}
...
var _bindata = map[string]func() (*asset, error){
	...
	"0013_add_use_mailservers.down.sql": _0013_add_use_mailserversDownSql,

	"0013_add_use_mailservers.up.sql": _0013_add_use_mailserversUpSql,
...
var _bintree = &bintree{nil, map[string]*bintree{
	...
	"0013_add_use_mailservers.down.sql":               &bintree{_0013_add_use_mailserversDownSql, map[string]*bintree{}},
	"0013_add_use_mailservers.up.sql":                 &bintree{_0013_add_use_mailserversUpSql, map[string]*bintree{}},
